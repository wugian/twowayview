...
public class ModuleFocusVerticalActivity extends AppCompatActivity {
    ...
    public int[] mStartIndex = {0, 1, 3, 7, 8, 9, 11, 12, 13, 14, 20, 21, 22, 23, 25, 26};
    public int[] mItemRowSizes = {2, 2, 1, 1, 1, 1, 1, 2, 2, 2, 2, 1, 1, 1, 1, 1};
    public int[] mItemColumnSizes = {1, 2, 1, 1, 1, 2, 1, 1, 1, 2, 1, 1, 1, 1, 1, 1};
